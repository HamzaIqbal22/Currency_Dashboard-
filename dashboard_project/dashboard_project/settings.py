...
SECRET_KEY = 'django-insecure-shzfn+cc(dh!bl=jy3py=a!s-fwj-_ouj!ahf-*+f3tb3gn5xt'
...
# For testing purposes, you might want to allow all origins (not recommended for production)
